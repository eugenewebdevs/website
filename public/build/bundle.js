...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	fa2 = new Fa({
    			props: { icon: faTwitter, size: "2x" },
    			$$inline: true
    		});

    	fa3 = new Fa({
    			props: { icon: faFacebook, size: "2x" },
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a0, "href", "/antonioortegajr");
    			add_location(a0, file$1, 5, 4, 197);
    			attr_dev(a1, "href", "/antonioortegajr");
    			add_location(a1, file$1, 6, 4, 265);
    			attr_dev(a2, "href", "/antonioortegajr");
    			add_location(a2, file$1, 7, 4, 335);
    			attr_dev(a3, "href", "/antonioortegajr");
    			add_location(a3, file$1, 8, 4, 404);
    			attr_dev(div, "class", "navIcons svelte-odbsr7");
    			add_location(div, file$1, 4, 0, 170);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			a = element("a");
    			a.textContent = "Link";
    			attr_dev(a, "href", "/antonioortegajr");
    			add_location(a, file$2, 3, 4, 46);
    			attr_dev(div, "class", "navIcons svelte-odbsr7");
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t4 = space();
    			p0 = element("p");
    			t5 = text("This is a starter template for a Svelte PWA, based in the ");
    			a = element("a");
    			a.textContent = "Svelte template";
    			t7 = space();
    			p1 = element("p");
    			p1.textContent = "You will find the manifest.json file and the service-worker.js file in the public folder";
    			t9 = space();
    			p2 = element("p");
    			t10 = text("To update the proper icons for the PWA check ");
    			i = element("i");
    			i.textContent = "/public/images/icons";
    			t12 = space();
    			create_component(footer.$$.fragment);
    			attr_dev(h1, "class", "svelte-1tky8bj");
    			add_location(h1, file$3, 8, 1, 149);
    			attr_dev(a, "href", "https://github.com/sveltejs/template");
    			attr_dev(a, "target", "_blank");
    			add_location(a, file$3, 9, 62, 234);
    			add_location(p0, file$3, 9, 1, 173);
    			add_location(p1, file$3, 10, 1, 322);
    			add_location(i, file$3, 11, 49, 467);
    			add_location(p2, file$3, 11, 1, 419);
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ name, Nav, Footer });
